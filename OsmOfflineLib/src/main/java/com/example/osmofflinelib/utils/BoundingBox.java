...
import static com.example.osmofflinelib.utils.MyMath.gudermann;
import static com.example.osmofflinelib.utils.MyMath.gudermannInverse;
...
public class BoundingBox implements Parcelable, Serializable {
    ...
    public static double getCenterLongitude(final double pWest, final double pEast) {
        ...
        return com.example.osmofflinelib.views.MapView.getTileSystem().cleanLongitude(longitude);
    }
