...
import com.example.osmofflinelib.utils.MyMath;
import com.example.osmofflinelib.utils.TileSystem;
import com.example.osmofflinelib.views.MapView.OnFirstLayoutListener;
    ...
    private static class MapAnimatorListener
        ...
        public MapAnimatorListener(final MapController pMapController,
            ...
            if (pOrientationEnd == null) {
                ...
                mOrientationSpan = (float) com.example.osmofflinelib.utils.MyMath.getAngleDifference(mOrientationStart, pOrientationEnd, pClockwise);
            }
        }
