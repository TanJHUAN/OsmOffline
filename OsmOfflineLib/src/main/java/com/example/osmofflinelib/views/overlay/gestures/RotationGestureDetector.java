package com.example.osmofflinelib.views.overlay.gestures;
 ...
 * to listen for rotation changes on the {@link MapView} then use {@link org.osmdroid.views.MapView#setMapListener(MapListener)}
