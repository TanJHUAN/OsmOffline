...
import com.example.osmofflinelib.views.drawing.MapSnapshot;

import java.util.ArrayList;

/**
 * {@link com.example.osmofflinelib.views.overlay.infowindow.InfoWindow} is a (pop-up-) View that can
 * be displayed on an {@link MapView}, associated to a
 * {@link com.example.osmofflinelib.api.IGeoPoint}.
 * <p>
 * Typical usage: cartoon-like bubbles displayed when clicking an overlay item (i.e. a
 * {@link com.example.osmofflinelib.views.overlay.Marker}).
