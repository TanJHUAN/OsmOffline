package com.example.osmofflinelib.views.overlay.infowindow;
...
import com.example.osmofflinelib.views.overlay.Marker;

/**
 * {@link com.example.osmofflinelib.views.overlay.infowindow.MarkerInfoWindow} is the default
 * implementation of {@link com.example.osmofflinelib.views.overlay.infowindow.InfoWindow} for a
 * {@link Marker}.
 * <p>
 * It handles
 * <p>
 * R.id.bubble_title          = {@link com.example.osmofflinelib.views.overlay.OverlayWithIW#getTitle()},
 * R.id.bubble_subdescription = {@link com.example.osmofflinelib.views.overlay.OverlayWithIW#getSubDescription()},
 * R.id.bubble_description    = {@link com.example.osmofflinelib.views.overlay.OverlayWithIW#getSnippet()},
