 ...
 * @deprecated Use {@link com.example.osmofflinelib.utils.MyMath} instead
 */
@Deprecated
public class MyMath {
    // ===========================================================
     ...
     * @param factor
     * @return
     * @deprecated Use {@link com.example.osmofflinelib.utils.MyMath#getNextSquareNumberAbove(float)} instead
     */
    @Deprecated
    public static int getNextSquareNumberAbove(final float factor) {
        return com.example.osmofflinelib.utils.MyMath.getNextSquareNumberAbove(factor);
    }
